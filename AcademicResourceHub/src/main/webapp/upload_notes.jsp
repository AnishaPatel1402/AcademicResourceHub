...
<div class="container mt-5">
    ...
    <div class="card shadow p-4">
        ...
        <form action="controller/uploadNotesController.jsp" method="post" enctype="multipart/form-data">
            ...
            <button style="background-color:#0a3d62; color:white" class="btn w-100">Upload Notes</button>
